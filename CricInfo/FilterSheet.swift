...
//  CricInfo
//
//  Created by Mohd Kashif on 17/07/24.
//
...
extension View {
    func MatchFilterSheet<T: View>(isPresented: Binding<Bool>, @ViewBuilder _ content: @escaping () -> T) -> some View {
        fullScreenCover(isPresented: isPresented) {
            FilterSheet(content: content)
        }
    }
}
